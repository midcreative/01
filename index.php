...
// ?Ä?Ä?Ä Bootstrap ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä
...
// ?Ä?Ä?Ä Read data from DB ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä
try {
    ...
    $petitionsStmt = $pdo->prepare("SELECT * FROM petitions WHERE status IN ('?¨È???Ω≤', 'Â∑≤È?Ê®?) ORDER BY created_at DESC");
...
$defaultSettings = [
    'HERO_TAG' => 'Â±èÊù±Á∏?≠∞?°Á¨¨‰∏âÈÅ∏?Ä?ÉÈÅ∏‰∫?,
    'HERO_HOME_TITLE_1' => '?ΩË??∞Êñπ?ÑÂ?Ë∑≥Ô?',
    'HERO_HOME_TITLE_2' => 'ËÆìÊ??ôÁ?Ê∫´Â∫¶Âª∂Á???,
    'HERO_ISSUES_TITLE_1' => '?øÊé•?ÅÊ??ãÁ?Ë®ó‰?Ôº?,
    'HERO_ISSUES_TITLE_2' => 'Ë®≠Ë??∞‰?‰ª??Â±èÊù±??,
    'HERO_FEEDBACK_TITLE_1' => '?ØÈ??ÜÈ??ÑÊ?ÂøóÔ?',
    'HERO_FEEDBACK_TITLE_2' => 'ÁøªË?ÂÆ∂È??ÑÊú™‰æÜ„Ä?,
    'HERO_CTA_SHOW' => '1',
    'HERO_CTA_TEXT' => '?ÉË???Ω≤ÂØ¶Ë?',
    'HERO_BG_IMAGE' => '',
];
...
<nav class="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-[#E0F2ED]">
    <div class="max-w-7xl mx-auto px-4 h-16 md:h-20 flex items-center justify-between">
        <div class="flex items-center gap-2 md:gap-3 py-2 cursor-pointer" onclick="switchView('home')">
            <div class="w-10 h-10 md:w-12 md:h-12 bg-brand-green rounded-xl flex items-center justify-center text-white shadow-lg shadow-[#66C2A5]/20 rotate-3 hover:rotate-0 transition-all">
                <span class="font-serif text-xl md:text-2xl font-bold">ÊΩ?/span>
            </div>
            <div class="flex flex-col text-left">
                <span class="font-serif text-lg md:text-2xl font-black tracking-tighter text-slate-800">
                    ÊΩòÁÇ©Á¶?<span class="brand-green font-sans text-sm md:text-lg font-bold ml-0.5">?çÂ??•Ë?</span>
                </span>
        ...
        <div class="hidden lg:flex items-center gap-8 text-sm font-bold tracking-wide">
            <button onclick="switchView('home')"     id="nav-home"     class="nav-btn brand-green border-b-2 border-brand-green pb-1">?âÈéÆË∂≥Ë∑°</button>
            <button onclick="switchView('issues')"   id="nav-issues"   class="nav-btn text-slate-500 hover:brand-green">Ë°åÂ??ΩÁöÆ??/button>
            <button onclick="switchView('feedback')" id="nav-feedback" class="nav-btn text-slate-500 hover:brand-green">??Ω≤ÂØ¶Ë?Á´?/button>
            <a href="/volunteer.php" class="nav-btn text-slate-500 hover:brand-green">ÂøóÂ∑•?õÂ?</a>
        </div>
        <div class="flex items-center gap-2">
            <a href="tel:081234567" class="bg-brand-green text-white px-4 md:px-6 py-2 md:py-2.5 rounded-full text-xs md:text-sm font-black shadow-lg shadow-[#66C2A5]/30 flex items-center gap-2 hover:bg-[#57A891] transition-all">
                <i data-lucide="message-square" class="w-3.5 h-3.5 md:w-4 md:h-4"></i> <span class="hidden xs:inline">Á∑ö‰??≥Ê?</span>
            </a>
    ...
    <div id="mobile-menu" class="hidden lg:hidden flex-col bg-white border-t border-[#E0F2ED] shadow-xl absolute top-full left-0 w-full pb-4 z-40 transition-all origin-top">
        <button onclick="switchView('home'); toggleMobileMenu()" id="mobile-nav-home" class="mobile-nav-btn py-4 text-brand-green font-bold border-b border-slate-50 hover:bg-slate-50 w-full text-center">?âÈéÆË∂≥Ë∑°</button>
        <button onclick="switchView('issues'); toggleMobileMenu()" id="mobile-nav-issues" class="mobile-nav-btn py-4 text-slate-600 font-bold border-b border-slate-50 hover:bg-slate-50 w-full text-center">Ë°åÂ??ΩÁöÆ??/button>
        <button onclick="switchView('feedback'); toggleMobileMenu()" id="mobile-nav-feedback" class="mobile-nav-btn py-4 text-slate-600 font-bold border-b border-slate-50 hover:bg-slate-50 w-full text-center">??Ω≤ÂØ¶Ë?Á´?/button>
        <a href="/volunteer.php" class="py-4 text-slate-600 font-bold border-b border-slate-50 hover:bg-slate-50 block w-full text-center">ÂøóÂ∑•?õÂ?</a>
    </div>
</nav>
...
<main class="max-w-7xl mx-auto px-4 py-8 md:py-12 text-left">
    ...
    <div id="view-home" class="view-content">
        ...
        <section class="mb-8 overflow-x-auto whitespace-nowrap pb-4 no-scrollbar -mx-4 px-4 text-center">
            <div class="flex flex-nowrap items-center justify-center gap-2.5">
                <button onclick="filterTown(this,'?®ÈÉ®?∞Â?')" class="town-btn active-town px-6 py-2 rounded-full text-xs font-bold bg-brand-green text-white shadow-md">?®ÈÉ®?∞Â?</button>
                <?php foreach ($towns as $town): if($town['name'] === '?®ÈÉ®?∞Â?') continue; ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8" id="service-list">
            <?php if (empty($posts)): ?>
            <div class="md:col-span-2 py-20 text-center text-slate-300 text-sm">Â∞öÊú™?âÊ??ôÊó•Ë®òÔ?Ë´ãÈÄèÈ?ÂæåÂè∞?∞Â???/div>
            <?php endif; ?>
            ...
            <article class="bg-white rounded-[2.5rem] overflow-hidden border border-slate-50 shadow-sm hover:shadow-lg transition-all flex flex-col group"
                ...
                <div class="aspect-[16/9] md:aspect-[16/10] bg-[#F4F8F7] relative p-6 flex items-center justify-center">
                    <span class="absolute top-4 left-4 px-4 py-1 rounded-full text-[9px] font-black uppercase tracking-[0.1em] border <?= $badgeClass ?>">
                        <?= htmlspecialchars($post['category_name'] ?? '?™Â?È°?) ?>
                    </span>
                </div>
                <?php endif; ?>
                <div class="p-6 md:p-10 flex flex-col flex-grow">
                    <div class="flex items-center gap-2 text-[9px] font-black text-slate-400 mb-3 tracking-wider">
                        ...
                        <?= htmlspecialchars($post['town_name'] ?? '?™Ê?ÂÆ?) ?>
                    ...
                    <div class="flex items-center justify-end">
                        <a href="/post/<?= htmlspecialchars($post['slug']) ?>" class="brand-green font-black text-xs flex items-center gap-1 hover:gap-3 transition-all">
                            ?±Ë??¥Â? <i data-lucide="arrow-right" class="w-3.5 h-3.5"></i>
                        </a>
                    </div>
                </div>
            </article>
    ...
    <div id="view-issues" class="view-content hidden-view animate-in fade-in max-w-5xl mx-auto text-left">
        <div class="text-center mb-10 md:mb-16">
            <h2 class="text-3xl md:text-5xl font-serif font-black text-slate-900 mb-4 leading-tight text-center">Ë°åÂ??ΩÁöÆ??/h2>
            <p class="text-slate-500 text-sm md:text-lg font-medium max-w-2xl mx-auto text-center leading-relaxed text-balance">
                ‰ª•Êï∏?öË®≠Ë®àÊú™‰æÜÔ??®Ë??ïÂ??âË?‰ªò„ÄÇÈÄôÊòØ?ëÂÄëÁÇ∫Â±èÊù±Á¨¨‰??∏Â?ÂÆöÁæ©?ÑÊ†∏ÂøÉÊîØ?±„Ä?
            </p>
        </div>

        <div class="space-y-8 md:space-y-12 text-left">
            <?php foreach ($whitepapers as $w): ?>
            <?php if ($w['theme_color'] === 'text-slate-900'): // ?πÂà•?ïÁ?Ê∑±Ëâ≤Ê®?? ?>
            <div class="bg-slate-900 rounded-[2.5rem] md:rounded-[3.5rem] p-8 md:p-16 text-white shadow-2xl relative overflow-hidden group text-left">
                ...
                <div class="relative z-10 text-left">
                    ...
                    <h3 class="text-3xl md:text-5xl font-serif font-black mb-6 text-left leading-tight"><?= nl2br(htmlspecialchars($w['title'] . ($w['subtitle'] ? "Ôºö\n" . $w['subtitle'] : ''))) ?></h3>
                    ...
                    <a href="/volunteer.php" class="inline-block px-10 py-4 bg-[#66C2A5] text-white rounded-2xl font-black text-sm shadow-xl hover:scale-105 transition-all text-center">?ÉË??∑ÁÖß??Ω≤</a>
                </div>
            </div>
            <?php else: // ‰∏Ä?¨Ê®£Âº??>
            ...
            <div class="text-center text-slate-300 py-20 text-sm">?ΩÁöÆ?∏ÂÖßÂÆπÁ??ô‰∏≠...</div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div id="view-feedback" class="view-content hidden-view max-w-5xl mx-auto">
        <div class="text-center mb-10 md:mb-16">
            <h2 class="text-3xl md:text-5xl font-serif font-black text-slate-900 mb-4 leading-tight text-center">Ë≠∞È???Ω≤ÂØ¶Ë?Á´?/h2>
            <p class="text-slate-500 text-sm md:text-lg font-medium max-w-2xl mx-auto text-center leading-relaxed text-balance">
                ÂØ¶Â??∂Ê?Ê°àÔ?Êª?50 ‰∫∫Ë?Ë≠∞Âç≥Ê≠??Á¥çÂÖ•Â∞àÊ?ËøΩËπ§?ÇÊÇ®?ÑÂ??áÔ??ØÈ??ïÊîπËÆäÁ??ãÂ???
            </p>
            ...
            <div class="mt-8">
                <button onclick="toggleProposeForm()" class="bg-[#2D7A60] hover:bg-[#1f5c48] text-white px-8 py-4 rounded-full font-black shadow-lg shadow-[#2D7A60]/30 transition-all flex items-center justify-center gap-2 mx-auto">
                    <i data-lucide="pen-tool" class="w-5 h-5"></i> ?ëË??™‰∏ª?êÊ?
                </button>
            </div>
        </div>
        ...
        <div id="propose-form-section" class="hidden mb-12 max-w-2xl mx-auto bg-white p-8 md:p-10 rounded-[2.5rem] shadow-xl border border-slate-50 relative overflow-hidden">
            ...
            <h3 class="text-2xl font-black text-slate-800 mb-6 font-serif">?ºËµ∑??Ω≤?êÊ?</h3>
            <p class="text-sm text-slate-500 mb-8 font-medium">?êÊ??ÅÂá∫ÂæåÔ?Á≥ªÁµ±Â∞áÂ?Â∞éÊÇ®?èÈ? LINE È©óË??üÂØ¶Ë∫´Â?ÔºàËá™?ïÊ??∫Á¨¨ 1 ‰ΩçÈÄ?Ω≤‰∫∫Ô??ÇÁ??çÂ??òÈ?ÂØ©Ê†∏Á¢∫Ë??ßÂÆπ?°È?Ê≥ïÊ?‰∏çÁï∂Ë®ÄË´ñÂ?ÔºåÂç≥?ÉÂú®Ê≠§ÂÖ¨?ãÈ??æÂ§ß?æÈÄ?Ω≤??/p>
            
            <form action="/api/petition-propose.php" method="POST" class="space-y-5">
                <div>
                    <label class="block text-sm font-black text-slate-800 mb-2">?êÊ?Ê®ôÈ? <span class="text-red-500">*</span></label>
                    <input type="text" name="title" required placeholder="Ë´ãÁ∞°?≠ÊâºË¶ÅË™™?éÊ?Ê°àÊ†∏Âø?
                ...
                <div>
                    <label class="block text-sm font-black text-slate-800 mb-2">?êÊ?Ë™™Ê? <span class="text-red-500">*</span></label>
                    <textarea name="description" rows="5" required placeholder="Ë´ãË©≥Á¥∞Ë™™?éÊ?Ê°àÂÖßÂÆπ„ÄÅË??ØÊ?Ë®¥Ê?"
                ...
                <div>
                    <label class="block text-sm font-black text-slate-800 mb-2">Ë≠∞È??ÜÈ? <span class="text-red-500">*</span></label>
                    <select name="category" required class="w-full bg-slate-50 border border-slate-100 rounded-2xl px-5 py-3 text-slate-800 focus:ring-4 focus:ring-[#E0F2ED] transition-shadow font-medium cursor-pointer">
                        <option value="" disabled selected>Ë´ãÈÅ∏?áÊ??∏È??ÑË≠∞È°åÂ?È°?/option>
                        <option value="Ëæ≤Ê•≠?áÁî¢??>Ëæ≤Ê•≠?áÁî¢??/option>
                        <option value="Â©¶Âπº?áÁ§æ?Ä?üÊ¥ª">Â©¶Âπº?áÁ§æ?Ä?üÊ¥ª</option>
                        <option value="?∑ËÄÖÁÖßÈ°?>?∑ËÄÖÁÖßÈ°?/option>
                        <option value="?íÂπ¥?πÂ??áÂú∞?πÂâµ??>?íÂπ¥?πÂ??áÂú∞?πÂâµ??/option>
                        <option value="‰∫§ÈÄöÂª∫Ë®≠Ë?ÂæÆÂ?ÁßªÂ?">‰∫§ÈÄöÂª∫Ë®≠Ë?ÂæÆÂ?ÁßªÂ?</option>
                        <option value="?ãÂ??á‰???>?ãÂ??á‰???/option>
                        <option value="?∂‰?Á∂úÂ?Ë≠∞È?">?∂‰?Á∂úÂ?Ë≠∞È?</option>
                    </select>
                </div>

                <div>
                    <label class="block text-sm font-black text-slate-800 mb-2">‰∫ã‰ª∂?∏È??âÈéÆ</label>
                    <select name="town" class="w-full bg-slate-50 border border-slate-100 rounded-2xl px-5 py-3 text-slate-800 focus:ring-4 focus:ring-[#E0F2ED] transition-shadow font-medium cursor-pointer">
                        <option value="?®ÈÉ®?∞Â?">?®ÈÉ®?∞Â?</option>
                        <?php foreach ($towns as $t): if($t['name'] === '?®ÈÉ®?∞Â?') continue; ?>
                ...
                <div class="pt-4">
                    <button type="submit" class="w-full bg-[#06C755] hover:bg-[#05b34d] text-white py-4 rounded-2xl font-black text-sm transition-colors shadow-lg shadow-[#06C755]/20 flex items-center justify-center gap-2">
                        <i class="fa-brands fa-line text-xl"></i> ‰∏ã‰?Ê≠•Ô??èÈ? LINE ÂØ¶Â?Ë™çË?‰∏¶ÁôºÂ∏?
                    </button>
                </div>
            </form>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div class="col-span-1 md:col-span-2 bg-white rounded-[2rem] p-12 text-center shadow-sm border border-slate-50">
                ...
                <p class="text-slate-400 font-medium">?ÆÂ?Â∞öÁÑ°?ãÊîæ‰∏≠Á???Ω≤?êÊ?</p>
            </div>
            <?php else: ?>
                ...
                <div class="bg-white rounded-[2rem] p-8 shadow-sm border border-slate-50 flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div>
                        <div class="flex items-center flex-wrap gap-2 mb-4 pr-10">
                            ...
                            <span class="inline-block px-3 py-1 bg-brand-green/10 text-brand-green text-xs font-black rounded-lg border border-brand-green/20">
                                <?= htmlspecialchars($p['category'] ?? 'Á∂úÂ?Ë≠∞È?') ?>
                            </span>
                            <span class="inline-block px-3 py-1 <?= $p['status'] === 'Â∑≤È?Ê®? ? 'bg-blue-50 text-blue-600' : 'bg-[#E0F2ED] text-[#2D7A60]' ?> text-xs font-black rounded-lg">
                    ...
                    <div>
                        <div class="flex justify-between text-sm font-bold mb-2">
                            <span class="text-slate-800"><?= (int)$p['current_count'] ?> ‰∫∫Â∑≤??Ω≤</span>
                            <span class="text-slate-400">?ÆÊ? <?= (int)$p['target_count'] ?> ‰∫?/span>
                        </div>
                        ...
                        <?php else: ?>
                            <a href="/api/line-login.php?id=<?= $p['id'] ?>" class="flex items-center justify-center w-full bg-[#06C755] hover:bg-[#05b34d] text-white py-4 rounded-xl font-black text-sm transition-colors shadow-lg shadow-[#06C755]/20">
                                <i class="fa-brands fa-line text-xl mr-2"></i> ‰ΩøÁî® LINE ‰∏Ä?µÈÄ?Ω≤
                            </a>
                        <?php endif; ?>
                        ...
                        <div class="mt-6 pt-5 border-t border-slate-100 flex items-center gap-3">
                            ...
                            <div class="text-xs text-slate-400 font-medium">
                                <span class="font-bold text-slate-700"><?= htmlspecialchars($petitionSignatures[count($petitionSignatures)-1]['line_display_name']) ?></span> Á≠â‰∫∫Â∑≤ÈÄ?Ω≤
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 md:px-4 grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16">
        <div class="md:col-span-5">
            <div class="flex items-center gap-2 mb-6">
                <div class="w-8 h-8 bg-brand-green rounded-lg flex items-center justify-center text-white font-serif font-black text-lg">ÊΩ?/div>
                <span class="font-serif font-black text-xl text-slate-800">ÊΩòÁÇ©Á¶?<span class="brand-green font-sans text-sm ml-0.5">?çÂ?Ëæ¶ÂÖ¨ÂÆ?/span></span>
            </div>
            <p class="text-slate-400 text-xs md:text-sm leading-relaxed font-medium mb-6">Ê∑±ËÄïÂ??±Á¨¨‰∏âÈÅ∏?Ä?Ç‰ª•Ëæ≤Ê??¢Èä∑?ÅË¶™Â≠êÊ??≤„ÄÅÈï∑?ßË?ÂøÉÈ??ØÊ?ÔºåÊâø?•ÊÇ®?ÑË?‰ªò„Ä?/p>
        </div>
        <div class="md:col-span-3">
            <h4 class="font-black text-xs mb-6 text-slate-800 tracking-[0.1em] uppercase">?çÂ?ÁØÑÂ?</h4>
            <div class="grid grid-cols-2 gap-y-3 text-slate-400 text-xs font-bold">
                <?php foreach (['ÊΩÆÂ???,'?∞Âü§??,'?ßÂ???,'?¨Â???,'Á´πÁî∞??,'?ãÂØÆ??] as $t): ?>
                <span><?= $t ?></span>
                <?php endforeach; ?>
            </div>
        </div>
...
function filterTown(el, town) {
    ...
    document.querySelectorAll('#service-list article').forEach(card => {
        card.style.display = (town === '?®ÈÉ®?∞Â?' || card.dataset.town === town) ? '' : 'none';
    });
}
...
FrontLayout::render($content, [
    'title'       => 'ÊΩòÁÇ©Á¶??çÂ??•Ë? | Â±èÊù±Á¨¨‰??∏Â??®Âú∞?çÂ??áÊ??è‰??ïÁ?',
    'description' => 'Â±èÊù±Á∏?≠∞?°Á¨¨‰∏âÈÅ∏?Ä?ÉÈÅ∏‰∫∫Ê??©Á?ÔºåÊ∑±?ïÊΩÆÂ∑ûÈéÆ?ÅÊñ∞?§È??ÅÂÖß?îÈ??ÅËê¨Â∑íÈ??ÅÁ´π?∞È??ÅÊ?ÂØÆÈ??ÇÁ??ÑËæ≤ÊºÅÁî¢?∑„ÄÅÈï∑?ß„ÄÅË¶™Â≠êÊ??≤Á??®Âú∞?çÂ?Ê°à‰???,
