<?php
// PHP script to write a perfect UTF-8 BOM file
\ = <<<EOT
# =========================================================================
...
// IMPORTANT: use correct encoding UTF8 with BOM so Windows Powershell 5.1 runs it properly
file_put_contents(__DIR__ . '/crawler_fixed.ps1', "\xef\xbb\xbf" . \);
echo "Written via PHP successfully.";
