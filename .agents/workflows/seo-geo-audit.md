...
```powershell
$r = Invoke-WebRequest "https://demo10.midcreative.com/demo/robots.txt" -UseBasicParsing
...
```powershell
# 確認首頁可存取
Invoke-WebRequest "https://demo10.midcreative.com/demo/" -UseBasicParsing | Select-Object StatusCode

# 確認 llms.txt 可存取
Invoke-WebRequest "https://demo10.midcreative.com/demo/llms.txt" -UseBasicParsing | Select-Object StatusCode

# 確認 sitemap 可存取
Invoke-WebRequest "https://demo10.midcreative.com/demo/sitemap.xml" -UseBasicParsing | Select-Object StatusCode
```
